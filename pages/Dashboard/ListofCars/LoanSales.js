...
//                                             </figure>
//                                             <div>
//                                                 <Link href={`/Dashboard/ListofCars/AllCars/${e._id}`} key={e._id}>
...
//                                                         <p>{ }</p>
//                                                         <div className="card-actions justify-end">
//                                                             {/* {e.LoanCar.toString() == "true" ? <div id="arived_car" className="badge badge-outline bg-green-500 text-black p-3">{l.arive} </div> : <div id="arived_car" className="badge badge-outline bg-red-500 text-black p-3">{l.notarive} </div>} */}
//                                                             {e.carCost.tobalance == "Loan" ? <div id="loan_car" className="badge badge-outline bg-red-300 text-black p-3">{l.loan}</div> : <div id="loan_car" className="badge badge-outline bg-green-200 text-black p-3">{l.cash}</div>}
//                                                         </div>
//                                                     </div></Link>
//                                             </div>
...
//                                             </figure>
//                                             <div>
//                                                 <Link href={`/Dashboard/ListofCars/LoanCar/${e._id}`} key={e._id}>
...
const LoanCar = () => {
    ...
    useMemo(() => {
        const GetCars = async () => {
            try {
                const res = await Axios.get(`/cars/isSoled/1/tobalance/Loan?search=${Search}&page=${Page}&limit=${Limit}`);
                // const res = await Axios.get(`/qarz/isSold/1?search=${Search}&page=${Page}&limit=${Limit}`);
                setNoCars(false)
                const data = await res.data;
                setData(data.carDetail)
                                        ...
                                        <div className="card   max-w-[400px] min-w-[300px]    bg-base-300 shadow-xl  " key={idx} >
                                            ...
                                            <Link href={`/Dashboard/ListofCars/AllCars/${e._id}`}><a><div>
                                                ...
                                                <div className="card-body z-50">
                                                    ...
                                                    <div className="card-actions justify-end">
                                                        {e.arrived == true ? <div id="arived_car" className="badge badge-outline bg-green-500 text-black p-3">{l.arive} </div> : <div id="arived_car" className="badge badge-outline bg-red-500 text-black p-3">{l.notarive} </div>}
