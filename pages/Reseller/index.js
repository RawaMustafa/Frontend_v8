  ...
  if(session.status ==="authenticated"){
        const getResellerData = async () => {
            ...
            try {
                ...
                const ress = await Axios.get(`/users/detail/${initQuery}`, {
                ...
                setTotalBalsData(ress.data.userDetail.TotalBals)
                ...
                <div className="p-5 border bg-white dark:bg-[#1E2021]  rounded-2xl shadow-xl drop-shadow-lg   active:scale-[98%] hover:scale-[99%] max-w-screen-xl min-w-[250px]">
                    <div className="flex items-center  justify-around  ">
                        ...
                        <div>
                            ...
                            <div className="text-2xl font-bold ">${TotalBalsData || " 0"}</div>
                        </div>
                        <div>
...
//     const router = useRouter()
//     const [dataReseller, setData] = useState()
//     const [Search, setSearch] = useState("");
//     const [Page, setPage] = useState(1);
...
//                             {
//                                 dataReseller?.carList?.map((e, idx) => {
//                                     const dataImage = []
...
//                                             </figure>
//                                             <Link href={`/Reseller/details/${e._id}`} ><a><div>
...
//                             }
//                         </div >
//                         {dataReseller?.carList.length >= Limit &&
